...
class WebSocketMessageHandler:
    ...
    def __init__(self, room_manager: RoomManager):
        ...
        self.handlers: Dict[str, Callable[[Dict[str, Any], Room, str], Coroutine[Any, Any, None]]] = {
    ...
    async def handle_message(
        ...
        if message_type is None:
            logging.warning("Message type is None")
            return
    ...
    async def _handle_move(self, data: Dict[str, Any], room: Room, player_color: str) -> None:
        """Handle move message."""
        from_pos = data["from"]
        to_pos = data["to"]
